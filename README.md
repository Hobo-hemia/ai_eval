...
├── modules/
│   ├── m1_arch/                # M1 题目、输入材料、harness、裁判规则
...
ai_eval init --models "gpt-5.2-codex,sonnet-4.5,gpt-5.3-codex-low-fast" --modules "m1,m2,m3,m4"
ai_eval run --module m1 --model "gpt-5.2-codex" --judge-model "opus-4.6"
...
- 自动产物：
  - `eval_records/<model_dir>/<module>/m1_result.proto|m2_result.go|m3_result.go|m4_result.go`
  - `eval_records/<model_dir>/<module>/m1_build.log|m2_build.log|m3_build.log|m4_build.log`
  - `eval_records/<model_dir>/<module>/m1_test.log|m2_test.log|m3_test.log|m4_test.log`
